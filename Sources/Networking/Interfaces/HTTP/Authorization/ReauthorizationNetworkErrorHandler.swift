...
///
/// This protocol extends the functionality required by a ``NetworkErrorHandler`` to decide whether reauthentication should be attempted by a ``ReauthorizingHTTPController`` using its ``ReauthorizationProvider``.
///
