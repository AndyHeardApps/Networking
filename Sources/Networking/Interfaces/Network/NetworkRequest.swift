...
public protocol NetworkRequest<ResponseType> {
    ...
    /// The headers for the request. There is no need to add authorization headers manually.
    ...
    ///     - decoder: The `JSONDecoder` to be used to decode the `Data`. This is provided by the `NetworkController` which can be set up to suit the API being interacted with.
    ///
